...
public class AddPropertyFinancialDetails extends WizardStep {
            ...
            public void onClick(View v) {
                ...
                dialogButton.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        itemMap.put("currency", AddPropertyFinancialDetails.this.mCurrency);
                        ...
                        AddPropertyFinancialDetails.this.itemList.add(itemMap);
                        AddPropertyFinancialDetails.this.adapter.notifyDataSetChanged();
                        dialog.dismiss();
                    }
                });
