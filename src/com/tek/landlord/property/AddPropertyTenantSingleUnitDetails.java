...
public class AddPropertyTenantSingleUnitDetails extends WizardStep {
    private EditText mStartTenancyButton;
    private EditText mEndTenancyButton;

    private Button mTenantAddButton;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.mTenantAddButton = (Button) v.findViewById(R.id.tenant_add_button);
        this.mTenantAddButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogButton.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        AddPropertyTenantSingleUnitDetails.this.itemList.add(itemMap);
                        AddPropertyTenantSingleUnitDetails.this.adapter.notifyDataSetChanged();
                        dialog.dismiss();
                    }
                });
