...
public class MultipleChoiceFragment extends ListFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        setListAdapter(new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_multiple_choice, android.R.id.text1, this.mChoices));
        ...
        new Handler().post(new Runnable() {
            ...
            public void run() {
                ArrayList<String> selectedItems = MultipleChoiceFragment.this.mPage.getData().getStringArrayList(Page.SIMPLE_DATA_KEY);
                ...
                for (int i = 0; i < MultipleChoiceFragment.this.mChoices.size(); i++) {
                    if (selectedSet.contains(MultipleChoiceFragment.this.mChoices.get(i))) {
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        ...
        this.mPage.getData().putStringArrayList(Page.SIMPLE_DATA_KEY, selections);
