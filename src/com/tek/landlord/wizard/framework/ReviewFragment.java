...
public class ReviewFragment extends ListFragment implements ModelCallbacks {
    ...
    private class ReviewAdapter extends BaseAdapter {
        ...
        public long getItemId(int position) {
            return ReviewFragment.this.mCurrentReviewItems.get(position).hashCode();
        }

        public View getView(int position, View view, ViewGroup container) {
            LayoutInflater inflater = LayoutInflater.from(getActivity());
            View rootView = inflater.inflate(R.layout.wizard_framework_list_item_review, container, false);

            ReviewItem reviewItem = ReviewFragment.this.mCurrentReviewItems.get(position);
